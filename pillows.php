...
// Fetch Pillows from DB
$dbProducts = mysqli_query($conn, "SELECT * FROM products WHERE category='Pillows'");
?>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        <div class="col-lg-3 col-md-4">
            <?php 
            $category = 'pillows'; // dynamically sets sidebar
        ...
        <div class="col-lg-9 col-md-8">
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <h2 class="mb-4">Pillows Collection</h2>
                </div>
                ...
                <?php else: ?>
                    <div class="col-12 text-center text-muted">
                        <p>No Pillows available at the moment.</p>
                    </div>
                <?php endif; ?>
